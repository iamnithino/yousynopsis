...
var _loadRequested, _hasLoaded, _isInit, _currentTime, _duration, _muted, _paused, _playbackRate, _progress, _readyState, _seeking, _volume, _videoWidth, _videoHeight, _config, _wasDisconnected, _onLoaded, _VimeoVideoElement_instances, setupApiListeners_fn, upgradeProperty_fn;
var VimeoVideoElement = class extends MediaPlayedRangesMixin(globalThis.HTMLElement ?? class {
  ...
  constructor() {
     ...
     * See load()
     */
    __privateAdd(this, _wasDisconnected, false);
    __privateAdd(this, _onLoaded, async () => {
  ...
  set config(value) {
    if (JSON.stringify(__privateGet(this, _config)) === JSON.stringify(value)) return;
  ...
  async load() {
    ...
    if (__privateGet(this, _isInit)) {
      ...
      await __privateGet(this, _onLoaded).call(this);
    ...
    const isSsrHydration = existingIframe && !__privateGet(this, _wasDisconnected);
    if (isSsrHydration) {
      if (!__privateGet(this, _config)) {
        __privateSet(this, _config, JSON.parse(existingIframe.getAttribute("data-config") || "{}"));
      }
    } else {
      this.shadowRoot.innerHTML = getTemplateHTML(namedNodeMapToObject(this.attributes), this);
    }
    __privateSet(this, _wasDisconnected, false);
    (_a = oldApi == null ? void 0 : oldApi.destroy) == null ? void 0 : _a.call(oldApi);
    const iframe = this.shadowRoot.querySelector("iframe");
    this.api = new player_es_default(iframe);
    __privateMethod(this, _VimeoVideoElement_instances, setupApiListeners_fn).call(this);
    await this.loadComplete;
  }
  connectedCallback() {
    var _a;
    if (__privateGet(this, _wasDisconnected)) {
      this.load();
    }
  ...
  disconnectedCallback() {
    var _a, _b, _c;
    __privateSet(this, _wasDisconnected, true);
    __privateSet(this, _loadRequested, null);
    __privateSet(this, _hasLoaded, null);
    __privateSet(this, _isInit, null);
...
_config = new WeakMap();
_wasDisconnected = new WeakMap();
_onLoaded = new WeakMap();
_VimeoVideoElement_instances = new WeakSet();
setupApiListeners_fn = function() {
  ...
  const onceLoaded = () => {
    ...
    __privateGet(this, _onLoaded).call(this);
  };
...
vimeo-video-element/dist/react.js:
  ...
  *)
*/
//# sourceMappingURL=react-XB6A5J5H.js.map
